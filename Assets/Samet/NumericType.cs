...
public class NumericType : IEquatable<NumericType>
{
    ...
    public NumericType(object obj)
    {
        ...
        {
            throw new Exceptions.NumericTypeExpectedException("The type of object in the NumericType constructor must be numeric.");
        }
        value = obj;
        type = obj.GetType();
    }
    ...
    public static bool operator <(NumericType left, NumericType right)
    {
        ...
        throw new Exceptions.NumericTypeExpectedException("Please compare valid numeric types.");
    }
